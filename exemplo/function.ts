...
function printarDados(valor1: number, valor2: number): void {
    return console.log(valor1 + valor2)
}
printarDados(3, 3)

function somarValoresNmericos(numero1: number, numero2: number, callback: (numero: number) => number): number {
